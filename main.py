...
# add logging to main.py by 2020.1.4
        ...
        try:
            ...
            if res[3] == 1 and res[4] == 0:
                ...
                if cls == 0 and score > 0.5:
                    ...
                    count = res1[0] + 1
                    show(count)
                    sql3 = "update info set result=1,count={},status2=1,new_obj=1 order by id desc limit 1;".format(
                        count)
                    cur.execute(sql3)
                    db.commit()
                    totle_count += 1
                    ...
                    count = res1[0] + 1
                    show(count)
                    sql = "update info set result=0,count={},status2=1,new_obj=1 order by id desc limit 1;".format(
                        count)
                    cur.execute(sql)
                    db.commit()
                    # time.sleep(2)
